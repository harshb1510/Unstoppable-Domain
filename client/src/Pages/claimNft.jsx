...
const ClaimNft = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("https://unstoppable-domain.onrender.com/claimNft", {
          method: "GET",
          headers: {
    ...
    try {
      const response = await fetch("https://unstoppable-domain.onrender.com/nft/claimSuccess", {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
